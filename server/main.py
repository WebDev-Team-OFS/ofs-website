...
app = Flask(__name__)
cors = CORS(app, supports_credentials=True, origins=["http://localhost:5173"], allow_credentials=True,
            expose_headers=['Set-Cookie'], methods=['GET', 'POST', 'PUT', 'DELETE', 'OPTIONS'])  # Enable CORS for frontend
