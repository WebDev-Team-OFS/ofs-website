...
test_products = [
    ...
    ("Almond Milk", "Silk", 50, 3.49, 1.0, False, "Dairy", "Indulge in the rich, smooth taste of Silk Organic Original Almond Milk. Carefully crafted from high-quality organic almonds, this plant-based milk alternative is certified USDA Organic and packed with natural goodness. With only 50 calories per serving, it offers a creamy, delicious flavor perfect for your morning cereal, smoothies, coffee, or just by itself.", None),
    ("Whole Grain Bread", "Baker's Choice", 75, 2.99, 0.8, False, "Grains", "Whole wheat bread is a wholesome, hearty option made from 100% whole grains, offering a rich source of fiber and essential nutrients. Its nutty flavor and soft texture make it perfect for sandwiches, toast, or pairing with soups and salads. Packed with vitamins, minerals, and complex carbohydrates, whole wheat bread is a nutritious choice for a balanced diet.", None),
    ("Baby Carrots", "Kroger", 75, 2.99, 0.8, False, "Produce", "Baby carrots are a convenient and healthy snack, naturally sweet and bite-sized for easy munching. Perfect for salads, lunchboxes, or on-the-go, they are rich in vitamins A and C, supporting vision and immune health. Pre-washed and ready to eat, baby carrots are a fresh, crunchy choice for any occasion!", None),
    ("Whole wheat Bread", "Dave's Killer", 75, 2.99, 0.8, False, "Grains", "Fuel your day with the hearty, nutritious goodness of Dave’s Killer Bread 21 Whole Grains and Seeds. Each slice is packed with a rich blend of organic whole grains and seeds, providing a robust flavor and a satisfying crunch. Perfect for sandwiches, toast, or as a standalone snack, this bread is not only delicious but also loaded with essential nutrients to keep you energized throughout the day.", None),
    ("Chocolate Chip Cookies", "Entenmann's", 75, 2.99, 0.8, False, "Snacks", "Mini chocolate cookies are bite-sized treats packed with rich, chocolaty goodness. Crispy on the outside and soft in the middle, they offer the perfect balance of sweetness in every bite. Ideal for snacking, sharing, or adding a sweet touch to any occasion, these mini cookies are a delicious indulgence for chocolate lovers!.", None),
    ("Large Farm Eggs", "Kirkland", 75, 2.99, 0.8, False, "Produce", "A dozen eggs are a versatile kitchen staple, rich in high-quality protein, vitamins, and minerals. Perfect for breakfast, baking, or adding to your favorite recipes, eggs are a nutritious and convenient ingredient. Whether scrambled, boiled, or fried, they provide endless meal possibilities and essential nutrients for a balanced diet.", None),
    ("Lunchly Fiesta Nachos with Prime", "Mr. Beast's", 75, 2.99, 0.8, False, "Snacks", "Lunchly is a convenient meal solution designed to make lunchtime easy and delicious. With a variety of wholesome, ready-to-eat options, Lunchly offers balanced meals that fit into your busy day. Whether you're craving fresh salads, hearty sandwiches, or protein-packed bowls, Lunchly provides nutritious and satisfying choices for every taste. Ideal for work, school, or on-the-go, Lunchly makes lunchtime simple, healthy, and enjoyable!", None),
...
("Laura's Ground Beef", "Laura's Lean Beef", 75, 2.99, 0.8, False, "Meats", "Enjoy guilt-free meals with Laura’s Lean 96% Lean Ground Beef. This high-quality ground beef is sourced from cattle raised without antibiotics or added hormones, ensuring a natural and nutritious option for your favorite recipes. With only 4% fat, it offers a leaner alternative that still delivers rich, hearty flavor without the extra calories.", None),
("Guerrero Tortilla", "Guerrero", 75, 2.99, 0.8, False, "Grains", "Bring authentic Mexican flavor to your table with Guerrero Riquísimas Soft Taco Flour Tortillas. These tortillas are crafted to be soft, flexible, and perfect for making delicious tacos, wraps, and quesadillas. With a rich and traditional taste, they’re ideal for adding a homemade touch to your meals and are designed to stay fresh and pliable for any dish.", None),
("Bush's Baked Beans ", "Bush's", 75, 2.99, 0.8, False, "Canned food", "Enjoy the classic taste of Bush’s Best Original Baked Beans, slow-cooked to perfection with a delicious blend of flavors. Infused with real bacon and brown sugar, these beans offer a rich, smoky-sweet taste that complements any meal, from barbecues to hearty dinners. With Bush’s secret family recipe, every bite brings wholesome goodness and unmatched flavor.", None),
("Daisy Sour Cream", "Daisy", 75, 2.99, 0.8, False, "Grains", "Enhance your favorite dishes with the creamy, rich taste of Daisy Sour Cream. Made with just one simple, natural ingredient, this sour cream delivers a pure, smooth texture that’s perfect for dolloping onto tacos, baked potatoes, or incorporating into dips and recipes. Trusted for its consistency and fresh flavor, Daisy brings a touch of quality to every meal.", None),
